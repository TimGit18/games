...
/**
 * Die Klasse ActionListenerBlack erweitert die abstrakte Oberklasse
...
public class ActionListenerTimBlack extends ActionListenerButton {

	// Statischer Logger für die Anwendung
	public static Logger LOG = LogManager.getLogger(ActionListenerTimBlack.class.getName());
	 ...
	 * @param selection
	 */
	public ActionListenerTimBlack(JTextArea textArea, String accessPath, String selection) {

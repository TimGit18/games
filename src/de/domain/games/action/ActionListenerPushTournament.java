...
public class ActionListenerPushTournament extends ActionListenerButton {

	// Statischer Logger für die Anwendung
	public static Logger LOG = LogManager.getLogger(ActionListenerPushTournament.class.getName());
	 ...
	 * @param selection
	 */
	public ActionListenerPushTournament(JTextArea textArea, String selection) {
	...
	public void actionPerformed(ActionEvent event) {
		...
		ProcessBuilder processBuilder = new ProcessBuilder("cmd.exe", "/c", "C:\\Users\\schmi\\Daten\\Text\\Github\\PushTurnier.bat");
